...
import SupervisorsHeader from './Header';
import Footer from './Footer';
import { SupervisorProfileProvider, useSupervisorProfileContext } from '../../contexts/SupervisorProfileContext';
...
const Layout = ({ children, title, subtitle, breadcrumbs = [] }) => {
  ...
  const { profile, loading: profileLoading } = useSupervisorProfileContext();
  ...
  return (
    ...
    >
      ...
      <header className="relative z-50">
        <SupervisorsHeader onMenuClick={() => setSidebarOpen(!sidebarOpen)} />
      </header>
