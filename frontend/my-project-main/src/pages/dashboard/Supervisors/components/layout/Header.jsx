...
const SupervisorsHeader = ({ title, subtitle, breadcrumbs = [], onMenuClick }) => {
  ...
  const { profile, loading: profileLoading, error: profileError } = useSupervisorProfile();
          ...
          >
            ...
            <div className="flex flex-col items-start text-left">
              <span className="text-black dark:text-gray-300 font-medium truncate">
                {profileLoading ? '...' : (profile?.fullName?.split(' ')[0] || 'مشرف')}
              </span>
              ...
              >
                ...
                <div className="py-2">
                  ...
                  <button
                    ...
                    onClick={() => {
                      setProfileMenuOpen(false);
                      navigate('/dashboard/supervisor/settings');
                    }}
                  >
