...
const navigationItems = [
  { id: 'dashboard', label: 'لوحة التحكم', icon: FaHome, path: '/dashboard/supervisor/dashboard' },
  { id: 'schools', label: 'المدارس', icon: FaSchool, path: '/dashboard/supervisor/schools' },
  { id: 'evaluations', label: 'التقييمات', icon: FaStar, path: '/dashboard/supervisor/evaluations' },
  { id: 'reports', label: 'التقارير', icon: FaFileAlt, path: '/dashboard/supervisor/reports' },
...
const bottomItems = [
  { id: 'profile', label: 'الملف الشخصي', icon: FaUser, path: '/dashboard/supervisor/profile' },
  { id: 'settings', label: 'الإعدادات', icon: FaCog, path: '/dashboard/supervisor/settings' },
];
...
const Sidebar = ({ isOpen, onToggle }) => {
  ...
  useEffect(() => {
    ...
    const currentItem = navigationItems.find(item => {
      ...
      return path.endsWith('/' + lastSegment) || path.endsWith('/' + lastSegment + '/') || path === item.path;
    ...
    } else if (path === '/dashboard/supervisor' || path === '/dashboard/supervisor/') {
      // Default to dashboard page for the base path
